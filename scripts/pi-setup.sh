...
curl -H "Content-Type: application/json" -X POST -d '{ "profile": { "axes": { "e": { "inverted": false, "speed": 300 }, "x": { "inverted": false, "speed": 6000 }, "y": { "inverted": false, "speed": 6000 }, "z": { "inverted": false, "speed": 6000 } }, "color": "default", "current": false, "default": false, "extruder": { "count": 2, "nozzleDiameter": 0.5, "offsets": [ [ 0.0, 0.0 ] , [ 0.0, 0.0 ] ] }, "heatedBed": true, "id": "rostock_max_v3_dual", "model": "Rostock Max V3 Dual", "name": "Rostock Max V3 Dual", "resource": "http://192.168.3.40/api/printerprofiles/rostock_max_v3_dual", "volume": { "depth": 275.0, "formFactor": "circular", "height": 400.0, "origin": "center", "width": 275.0 } }}' http://localhost/api/printerprofiles?apikey=ABAABABB
